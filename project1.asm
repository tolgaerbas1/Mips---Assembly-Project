.data 		
	...
	#-------------------------------SPACES FOR SECOND QUESTION--------------------------------------
	
	buffer:			.space 1024
	firstMatrixBuffer: 	.space 1024
	secondMatrixBuffer: 	.space 1024
	firstDimensionBuffer: 	.space 8
	secondDimensionBuffer:	.space 8
	...
	#-------------------------------STRING MESSAGES FOR FIRST QUESTION-------------------------------------
	
	getValuesMessage:  	.asciiz "Enter the number of iteration for the series: "
	
	#-------------------------------STRING MESSAGES FOR SECOND QUESTION-------------------------------------
	...
	#-------------------------------STRING MESSAGES FOR THIRD QUESTION-------------------------------------
	...
	#-------------------------------STRING MESSAGES FOR MENU AND GENERAL-------------------------------------
